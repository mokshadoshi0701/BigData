...
(X_train,y_train),(X_validate,y_validate),(X_test,y_test) = load_n_combine_df(path_to_data='Assignment2/model/sevir_model/data/sevir/',features_to_keep=np.arange(0,1,1),class_labels=False,dropzeros=True)
...
path= 'Assignment3/model/sevir_model/models/modelLinearRegression.pkl'
